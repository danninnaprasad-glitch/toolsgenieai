  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-16 pt-8">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-fuchsia-600 dark:from-indigo-400 dark:to-fuchsia-400">
            Tech Essentials
        </h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 pb-12">
        {PRODUCTS.map((product, i) => (
          <div key={product.id} className="group bg-white dark:bg-surface rounded-2xl overflow-hidden border border-slate-200 dark:border-white/5 hover:border-indigo-500/50 transition-all duration-300 flex flex-col h-full hover:-translate-y-1 shadow-lg hover:shadow-indigo-500/10">
            {/* Visual Header */}
            ...
            <div className="p-6 flex-grow flex flex-col">
              <div className="mb-3">
                 <span className="text-xs font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider bg-indigo-500/10 px-2 py-1 rounded">
                    {product.category}
                 </span>
              </div>
              
              <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors">
                {product.name}
              </h3>
              ...
              {product.price && (
                  <div className="text-lg font-bold text-slate-900 dark:text-white mb-4">{product.price}</div>
              )}

              <Button variant="outline" className="w-full mt-auto border-slate-300 dark:border-slate-700 hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 text-slate-600 dark:text-slate-300 hover:text-indigo-700 dark:hover:text-white">
                View Specs
              </Button>
            </div>
          </div>
